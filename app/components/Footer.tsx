    ...
    <footer className="mt-20 border-t border-[var(--line)] bg-[rgba(255,250,243,0.9)]">
      <div className="mx-auto max-w-7xl px-5 py-14 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div className="rounded-[28px] border border-[var(--line)] bg-white/70 p-6 shadow-[0_14px_45px_rgba(92,60,37,0.08)]">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--olive)]">
              {siteSettings.brandName} Pantry Notes
            </p>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 text-sm text-stone-700">
              ...
              <Link href="/about" className="hover:text-[var(--brand-deep)]">
                About Us
              </Link>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 text-sm text-stone-700">
              <a href={`mailto:${siteSettings.manufacturerEmail || "hello@kanvi.com"}`} className="hover:text-[var(--brand-deep)]">
                {siteSettings.manufacturerEmail || "hello@kanvi.com"}
              </a>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 text-sm text-stone-700">
              <Link href="/terms" className="hover:text-[var(--brand-deep)]">
                Terms & Conditions
              </Link>
              <Link href="/privacy-policy" className="hover:text-[var(--brand-deep)]">
                Privacy Policy
              </Link>
              <Link href="/refund-policy" className="hover:text-[var(--brand-deep)]">
                Refund Policy
              </Link>
            </div>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-[var(--line)] pt-6 text-sm text-stone-500 md:flex-row md:items-center md:justify-between">
          <p>{`© 2026 ${siteSettings.brandName}. Homemade taste, packed with care.`}</p>
